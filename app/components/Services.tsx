...
export default function Services() {
 ...
 <a
 href="#services"className="inline-flex items-center justify-center rounded-full border border-zinc-200 bg-white px-6 py-3 text-sm font-medium shadow-sm transition-colors hover:bg-zinc-100 :bg-zinc-800">
 ...
 <div
 key={index}
 className="group relative rounded-3xl border border-zinc-100 bg-white p-8 shadow-sm transition-all hover:shadow-md :border-zinc-700">
 <div className="mb-6 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-[#242424] text-white">
 ...
 <div className="mt-6 flex items-center text-sm font-medium text-[#242424] opacity-0 transition-opacity group-hover:opacity-100">
