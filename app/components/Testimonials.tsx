...
export default function Testimonials() {
 ...
 <div
 key={index}
 className="relative rounded-3xl border border-zinc-100 bg-zinc-50 p-8 shadow-sm">
 <FaQuoteLeft className="mb-4 h-8 w-8 text-[#242424]/20"/>
 <div className="flex gap-1 text-yellow-400 mb-4">
 {[...Array(5)].map((_, i) => (
 <FaStar key={i} />
 ))}
 </div>
 <p className="mb-6 text-zinc-600 italic">"{testimonial.text}"</p>
