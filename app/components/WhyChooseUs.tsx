...
export default function WhyChooseUs() {
 ...
 <Image
 src="https://images.unsplash.com/photo-1717501218636-a390f9ac5957"alt="About Image"fill
 className="object-cover"/>
 </div>
 <div className="h-64 w-full rounded-2xl bg-zinc-300 relative overflow-hidden">
 <Image
 src="https://images.unsplash.com/photo-1688380692117-63178554d76d"alt="About Image"fill
 className="object-cover"/>
 </div>
 </div>
 ...
 <div className="h-64 w-full rounded-2xl bg-zinc-300 relative overflow-hidden">
 <Image
 src="https://images.unsplash.com/photo-1543269865-cbf427effbad"alt="About Image"fill
 className="object-cover"/>
 </div>
 <div className="h-48 w-full rounded-2xl bg-zinc-200 relative overflow-hidden">
 <Image
 src="https://images.unsplash.com/photo-1521295121783-8a321d551ad2"alt="About Image"fill
 className="object-cover"/>
 </div>
 </div>
 </div>
