...
export default function Navbar() {
 ...
 <button className="p-2 text-zinc-600 hover:text-black :text-white transition-colors">
 <IoSearch className="w-5 h-5"/>
 </button>
 <Link
 href="mailto:core@pivothire.tech"className="inline-flex h-9 items-center justify-center rounded-full bg-black px-6 text-sm font-medium text-white shadow transition-colors hover:bg-zinc-800 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 :bg-zinc-200">
 Get a Quote
 </Link>
 </div>
