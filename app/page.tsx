                ...
                <div className="bg-[#242424] text-white rounded-t-[2.5rem] mx-4 lg:mx-8">
                    <section className="container mx-auto px-4 py-20 text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <a
                                href="mailto:core@pivothire.tech" className="inline-flex h-12 items-center justify-center rounded-full border border-zinc-700 bg-transparent px-8 text-sm font-medium text-white transition-colors hover:bg-zinc-900">
                                Contact Sales
                            </a>
                        </div>
                    </section>
